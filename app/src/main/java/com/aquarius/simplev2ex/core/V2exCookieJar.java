...
public class V2exCookieJar implements CookieJar {

    private final CookieHandler mCookieHandler;

    public V2exCookieJar(CookieHandler cookieHandler) {
    ...
    public void saveFromResponse(HttpUrl url, List<Cookie> cookies) {
        if (mCookieHandler != null) {
            ...
            try {
                ...
                Log.d("CookiesManager", "Saving cookies failed for \" + url.resolve(\"/...\")" + e.getMessage());
            }
        }
    }
    ...
    public List<Cookie> loadForRequest(HttpUrl url) {
        ...
        try {
            ...
            Log.d("CookiesManager", "Loading cookies failed for \" + url.resolve(\"/...\")" + e.getMessage());
